...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DXuxTScr.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CxlEzIFT.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bhsj5LcS.js"));
