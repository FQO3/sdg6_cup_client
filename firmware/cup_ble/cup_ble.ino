 ...
 *
 * ADC 精度：ESP32-S3 ADC1 为 12-bit，量程 0~4095，输入范围 0~3.3V。
 */
...
void setup() {
  ...
  // ESP32-S3 ADC1：12-bit 精度 + 12dB 衰减（满量程约 0~3.1V，可读到 3.3V 附近）
  ...
  Serial.println("AquaCup ESP32-S3-MINI booted with real ADC sensors (12-bit)");
